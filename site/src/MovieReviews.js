class ReviewItem extends React.Component {
	...
	render() {
		return <div className='ReviewItem' data-id={this.props.review.creator_id}>
			<span>{this.props.review.review}. <br /> Stars: {this.props.review.star_rank}<br /><br /></span>
		</div>
	}
}
    ...
    render() {
		return <div>
			<div>
                ...
                <img src={this.state.movie.image_url} width="250px" height="250px"></img>
            </div>
			Write a new review:
			<div>
				...
				<br />
				<input type="name" id="movie" placeholder="Movie Name" required />
				<br />
				<input type="text" id="review" placeholder="Review" required />
				<br />
				<input type="text" id="stars" placeholder="Stars" />
				<br />
			...
			<div>
				...
				<span style={{ display: (this.state.reviews.length ? 'none' : 'block') }}>
