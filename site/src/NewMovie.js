class NewMovie extends React.Component {
    ...
    render() {
		return <div>
                ...
                <br />
				<input type="name" id="movie_name" placeholder="Movie Name" required />
                <br />
				<input type="url" id="image_url" placeholder="Image" required />
				<br />
				<button onClick={this.handle_click}>Add</button>
		</div>
    }
}